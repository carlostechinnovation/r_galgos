...
out_multicore_cv <- predict.SuperLearner(object = modelo_multicore_con_cv, newdata = x_test, onlySL = TRUE) #No usa los que tienen peso =0
print('PREDICCION:')
out_multicore_cv_predicho_algor1 <- out_multicore_cv$library.predict[,1]; str(y_test_predicho_algor1)
out_multicore_cv_predicho_algor2 <- out_multicore_cv$library.predict[,2]; str(y_test_predicho_algor2)
print('ESPERABLE:')
str(y_test)
qplot(y_test, out_multicore_cv_predicho_algor1) #Scatterplot
qplot(y_test, out_multicore_cv_predicho_algor2) #Scatterplot
