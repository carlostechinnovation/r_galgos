...
analisis_modelos_superlearner <- function(matrizentrada){
  ...
  #HYPERPARAMETROS: override default parameters of some functions to fit better
  ...
  algoritmosPredictivosUsados <- list("SL.bartMachine", "SL.bayesglm",  
                                      "SL.glm", "SL.xgboost",
                                      # learners_rf$names, 
                                      "SL.randomForest",
                                      "SL.ksvm", "SL.ranger",  "SL.ridge",  "SL.rpart", "SL.svm")
  ...
  #-------------------- MULTICORE -------------
  # print('Multicore (snow o multicore')
  # num_cores = RhpcBLASctl::get_num_cores()
  # print(paste('Numero cores = ', num_cores))
  # options(mc.cores = num_cores) #Uso todas las CPUs
  ...
  # system.time({
  #   cv_sl = CV.SuperLearner(Y = y_train, X = x_train, family = gaussian(), V = 3, SL.library=algoritmosPredictivosUsados,
  ...
  #SUPERLEARNER
  print('SUPERLEARNER con solo UN core:')
  modelo_super <- SuperLearner(Y = y_train, X = x_train,
                               family = gaussian(), 
